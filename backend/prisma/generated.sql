...
-- CreateTable
CREATE TABLE "_nofiticationsTousers" (
    "A" UUID NOT NULL,
    "B" UUID NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_nofiticationsTousers_AB_unique" ON "_nofiticationsTousers"("A" ASC, "B" ASC);

-- CreateIndex
CREATE INDEX "_nofiticationsTousers_B_index" ON "_nofiticationsTousers"("B" ASC);
...
-- AddForeignKey
ALTER TABLE "_nofiticationsTousers" ADD CONSTRAINT "_nofiticationsTousers_A_fkey" FOREIGN KEY ("A") REFERENCES "nofitications"("notification_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_nofiticationsTousers" ADD CONSTRAINT "_nofiticationsTousers_B_fkey" FOREIGN KEY ("B") REFERENCES "users"("user_id") ON DELETE CASCADE ON UPDATE CASCADE;
